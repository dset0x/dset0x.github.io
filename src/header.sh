...
<head>
    ...
    <style>
        ...
        article .preview .cont {position: absolute; bottom: 0; right: 0; background: #fffdff; font-size: small; box-shadow: 0px 0px 0.5ch 0.5ch white; display: table-cell; vertical-align: bottom;}
