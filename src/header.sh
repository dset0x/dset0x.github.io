...
<head>
    ...
    <style>
        ...
        article .preview {max-height: 20vw; overflow:hidden; opacity: 0.9; margin-left: 4ch; z-index: 3;}
        ...
        #menu li                    {display: block; float:right; clear:both; padding: 0.2em 0 0.2em 0;}
